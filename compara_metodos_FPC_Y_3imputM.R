#Construction of models by fpc() for the data WITHOUT the transformation of the
...
fit_mc_ps.3.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "ps", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
      )


fit_mc_ps.3.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "ps", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
      )

# Works fine
fit_mc_ps.4.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "ps", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_mc_ps.4.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "ps", k = 4, fx = FALSE),
      subset = (1:N)[-test]
      )
...
fit_mc_ps.5.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "ps", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_mc_ps.5.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "ps", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_mc_tp.3.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "tp", k = 3, fx = TRUE),
      subset = (1:N)[-test]
      )
...
fit_mc_tp.3.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "tp", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_mc_tp.4.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "tp", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_mc_tp.4.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "tp", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_mc_tp.5.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "tp", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_mc_tp.5.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "tp", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_mc_cr.3.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "cr", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_mc_cr.3.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "cr", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_mc_cr.4.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "cr", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_mc_cr.4.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "cr", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_mc_cr.5.t <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "cr", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_mc_cr.5.f <- 
  pfr(y ~ fpc(medida_colo_imp, bs = "cr", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_nc_ps.3.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "ps", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
      )

fit_nc_ps.3.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "ps", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
      )

# Works fine
fit_nc_ps.4.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "ps", k = 4, fx = TRUE),
      subset = (1:N)[-test]
      )
...
fit_nc_ps.4.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "ps", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_nc_ps.5.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "ps", k = 5, fx = TRUE),
      subset = (1:N)[-test]
      )
...
fit_nc_ps.5.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "ps", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_nc_tp.3.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "tp", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_nc_tp.3.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "tp", k = 3, fx = FALSE),
      subset = (1:N)[-test]
      )
...
fit_nc_tp.4.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "tp", k = 4, fx = TRUE),
      subset = (1:N)[-test]
      )
...
fit_nc_tp.4.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "tp", k = 4, fx = FALSE),
      subset = (1:N)[-test]
      )
...
fit_nc_tp.5.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "tp", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_nc_tp.5.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "tp", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_nc_cr.3.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "cr", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_nc_cr.3.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "cr", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_nc_cr.4.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "cr", k = 4, fx = TRUE),
      subset = (1:N)[-test]
      )
...
fit_nc_cr.4.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "cr", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_nc_cr.5.t <- 
  pfr(y ~ fpc(num_contra_imp, bs = "cr", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
      )
...
fit_nc_cr.5.f <- 
  pfr(y ~ fpc(num_contra_imp, bs = "cr", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
      )
...
fit_mc_ps.3.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "ps", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )


fit_mc_ps.3.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "ps", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )

# Works fine
fit_mc_ps.4.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "ps", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_ps.4.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "ps", k = 4, fx = FALSE),
      subset = (1:N)[-test]
  )
...
fit_mc_ps.5.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "ps", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_ps.5.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "ps", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.3.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "tp", k = 3, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_mc_tp.3.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "tp", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.4.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "tp", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.4.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "tp", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.5.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "tp", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.5.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "tp", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.3.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "cr", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.3.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "cr", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.4.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "cr", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.4.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "cr", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.5.t <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "cr", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.5.f <- 
  pfr(y ~ fpc(medida_colo_compl, bs = "cr", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_ps.3.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "ps", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )

fit_nc_ps.3.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "ps", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )

# Works fine
fit_nc_ps.4.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "ps", k = 4, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_nc_ps.4.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "ps", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_ps.5.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "ps", k = 5, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_nc_ps.5.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "ps", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_tp.3.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "tp", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_nc_tp.3.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "tp", k = 3, fx = FALSE),
      subset = (1:N)[-test]
  )
...
fit_nc_tp.4.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "tp", k = 4, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_nc_tp.4.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "tp", k = 4, fx = FALSE),
      subset = (1:N)[-test]
  )
...
fit_nc_tp.5.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "tp", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_nc_tp.5.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "tp", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.3.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "cr", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.3.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "cr", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.4.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "cr", k = 4, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_nc_cr.4.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "cr", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.5.t <- 
  pfr(y ~ fpc(num_contra_compl, bs = "cr", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.5.f <- 
  pfr(y ~ fpc(num_contra_compl, bs = "cr", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_ps.3.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "ps", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )


fit_mc_ps.3.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "ps", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )

# Works fine
fit_mc_ps.4.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "ps", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_ps.4.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "ps", k = 4, fx = FALSE),
      subset = (1:N)[-test]
  )
...
fit_mc_ps.5.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "ps", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_ps.5.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "ps", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.3.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "tp", k = 3, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_mc_tp.3.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "tp", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.4.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "tp", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.4.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "tp", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.5.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "tp", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_tp.5.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "tp", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.3.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "cr", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.3.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "cr", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.4.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "cr", k = 4, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.4.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "cr", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.5.t <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "cr", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_mc_cr.5.f <- 
  pfr(y ~ fpc(medida_colo_compl_soIG , bs = "cr", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_ps.3.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "ps", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )

fit_nc_ps.3.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "ps", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )

# Works fine
fit_nc_ps.4.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "ps", k = 4, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_nc_ps.4.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "ps", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_ps.5.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "ps", k = 5, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_nc_ps.5.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "ps", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_tp.3.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "tp", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_nc_tp.3.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "tp", k = 3, fx = FALSE),
      subset = (1:N)[-test]
  )
...
fit_nc_tp.4.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "tp", k = 4, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_nc_tp.4.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "tp", k = 4, fx = FALSE),
      subset = (1:N)[-test]
  )
...
fit_nc_tp.5.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "tp", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_nc_tp.5.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "tp", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.3.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "cr", k = 3, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.3.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "cr", k = 3, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.4.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "cr", k = 4, fx = TRUE),
      subset = (1:N)[-test]
  )
...
fit_nc_cr.4.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "cr", k = 4, fx = FALSE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.5.t <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "cr", k = 5, fx = TRUE), 
      subset = (1:N)[-test]
  )
...
fit_nc_cr.5.f <- 
  pfr(y ~ fpc(num_contra_compl_soIG , bs = "cr", k = 5, fx = FALSE), 
      subset = (1:N)[-test]
  )
